...
python utils/pre-cate.py data/criteo/sample_offline0.csv data/criteo/sample_offline0.cate -d sample_offline -t 1
python utils/pre-cate.py data/criteo/sample_offline1.csv data/criteo/sample_offline1.cate -d sample_offline -p test -t 1
